...
//import com.wine.to.up.user.service.messaging.TestTopicKafkaMessageHandler;
...
//        return new BaseKafkaHandler<>(userServiceApiProperties.getMessageSentEventsTopicName(), new KafkaConsumer<>(consumerProperties), handler);
//    }
//
//    /**
...
//
//        return new KafkaMessageSender<>(new KafkaProducer<>(producerProperties), userServiceApiProperties.getMessageSentEventsTopicName(), metricsCollector);
//    }
//}
