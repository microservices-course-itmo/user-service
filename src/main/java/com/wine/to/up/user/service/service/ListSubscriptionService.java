...
public class ListSubscriptionService
    extends AbstractService<Long, ListSubscriptionDto, ListSubscription, ListSubscriptionRepository> {
    private final ListSubscriptionRepository listSubscriptionRepository;
    private final UserRepository userRepository;

    @Autowired
    public ListSubscriptionService(ListSubscriptionRepository repository, ModelMapper modelMapper,
                                   ListSubscriptionRepository listSubscriptionRepository,
    ...
    public List<ListSubscriptionDto> findUsersByItemId(Long id) {
        ...
        for (ListSubscription listSubscriptionDto : listSubscriptionRepository.findAllByItemId(id)) {
    ...
    public ListWineUserDto getUserTokens(Long id) {
        ...
        for (ListSubscriptionDto listSubscriptionDto : listSubscription) {
